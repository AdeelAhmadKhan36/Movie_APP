...
import '../model/movie_model.dart'; // Ensure this is suitable for both lists and details
...
class ApiService extends BaseApiService {
  ...
  Future<List<MovieModel>> searchMovies(String query) async {
    try {
      final response = await client.get(Uri.parse('$baseUrl?s=$query&apikey=$apiKey'));
  ...
  Future<MovieModel> getMovieDetails(String movieId) async {
    try {
      final response = await client.get(Uri.parse('$baseUrl?i=$movieId&apikey=$apiKey'));
